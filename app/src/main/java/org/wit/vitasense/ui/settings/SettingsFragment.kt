...
class SettingsFragment : Fragment() {
    ...
    override fun onViewCreated(
        ...
        binding.lightThemeButton.setOnClickListener { viewModel.setTheme(ThemeMode.LIGHT) }
        binding.darkThemeButton.setOnClickListener { viewModel.setTheme(ThemeMode.DARK) }
                    ...
                    viewModel.themeMode.collect { mode ->
                        binding.themeStatus.text =
                            if (mode == ThemeMode.DARK) {
                                getString(org.wit.vitasense.R.string.theme_dark)
                            } else {
                                getString(org.wit.vitasense.R.string.theme_light)
                            }
                    }
                }
